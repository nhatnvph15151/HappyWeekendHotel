            ...
            <div className='container px-[90px] bg flex justify-between pb-[90px]'>
                ...
                <div className='form mx-[auto]  w-[50%]'>
                    ...
                    <form className="mt-8 space-y-6" action="#" method="POST">
                        <input disabled type="hidden" name="remember" defaultValue="true" />
                        <div className="-space-y-px rounded-md shadow-sm">
                            <div className='pt-[30px]'>
                                <label htmlFor="password" className='mt-[30px]' >Name</label>
                                <input id="text" name="password" type="password" autoComplete="current-password" className=" relative  block w-full appearance-none rounded-md border border-gray-300 px-3 py-3 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Password" />
                            </div>
                            <div className='pt-[30px]'>
                            ...
                            <div className='pt-[30px]'>
                                ...
                                <input id="password" name="password" type="password" autoComplete="current-password" className="relative  block w-full appearance-none rounded-md border border-gray-300 px-3 py-3 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" placeholder="Password" />
                            </div>
                        </div>
                        ...
                        <div>
                            <button  type="button" className="group relative flex w-full justify-center rounded-md border border-transparent bg-[#FFA500] py-2 px-4 text-sm font-medium text-white hover:bg-[#fed496] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
